...
function LimpiarDatos(){
    let inventario = ["Error", "Laptop", "Mause", "Teclado", "Virus"];
    inventario.shift();
    inventario.pop();
...
function matriFrutas(){
    let caja = [
        ["Frutas", "Verduras"],
        [["Manzanas", "Pera"],["Tomate", "Lechuga"]]
    ];
